...
onMounted(() => {
  ...
  appName.value = decodeURI(route.path || "Unknown").replace('/', ' ');
});
</script>
...
<template>
  <div>
    ...
    <p>This privacy policy applies to the {{ appName }} app (hereby referred to as "Application") for mobile devices that
      was created by Ashvini jangid (hereby referred to as "Service Provider") as a Free service. This service is
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
      ...
      please contact them at ashvinijangid@gmail.com and they will respond in a reasonable time.</p>
    ...
    <div><br>
      <p>The Application does not address anyone under the age of 13.
        ...
        personal information, please contact the Service Provider (ashvinijangid@gmail.com) so that
    ...
    <p>This privacy policy is effective as of 2024-11-11</p><br><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
      please contact the Service Provider via email at ashvinijangid@gmail.com.</p>
    <hr>
